/* ============================================================
   REALITY — RISO PHOTO ENGINE (Print Studio copy — white paper)
...
(function(){
  ...
  const PAPER = { day:'#ffffff', night:'#0a0703' };  // Print: true-white paper (NOT the cream brand stock)
  const INK   = { day:'#111111', night:'#fffbf1' };  // Print: match INK.rgb in print-data
  ...
  function render(cv, name, opts){
    const o=Object.assign({ ink:'pink', paper:'night', contrast:1.18, brightness:0, dot:9, bands:4, threshold:0.52,
      ...
      spotLo:0.35, spotHi:0.65, spotSoft:0.08, spotInvert:false, spotBase:'duotone', transparent:false, fit:'cover', paperFill:null }, opts||{});
