...
export const Icons = {
  ...
  buy: (c = "currentColor") => (
    <Svg label="Buy" color={c}>
      ...
      <rect x="8" y="19" width="2.5" height="2.5"/>
      <rect x="15.5" y="19" width="2.5" height="2.5"/>
    </Svg>
  ),

  lightbulb: (c = "currentColor") => (
  ...
  arrow: (c = "currentColor", direction = "right") => {
    const paths = {
