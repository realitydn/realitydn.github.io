// Tiếng Việt. Mirrors locales/en.js key-for-key — see that file for the
...
export default {
  ...
  "eventGuidelines": {
    ...
    "crossRefs": {
      "promote": "Cách REALITY có thể Hỗ trợ Quảng bá",
      "branding": "hướng dẫn thương hiệu"
    }
  },
  "hostGuide": {
    "title": "Hướng dẫn tổ chức",
    "message": "Trang này sẽ sớm ra mắt. Quay lại sau để xem hướng dẫn đầy đủ về việc tổ chức sự kiện tại REALITY.",
